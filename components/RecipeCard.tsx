...
const RecipeCard: React.FC<RecipeCardProps> = ({ recipe, onSave }) => {
  return (
    <div
      ...
      className="rounded-2xl shadow-lg p-6 flex flex-col border-t-4 transform hover:-translate-y-2 transition-transform duration-300"
    >
      <div className="flex justify-between items-start mb-3">
        <h3 className="text-2xl font-bold font-serif text-[var(--text-color)] pr-2">{recipe.title}</h3>
        <button
      ...
      <div className="mt-auto">
        <h4 className="font-semibold mb-2 text-[var(--text-color)]">Key Ingredients:</h4>
